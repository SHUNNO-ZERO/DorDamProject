...
public class barishal extends AppCompatActivity   implements View.OnClickListener  {
            ...
            dbProducts.add(product)
                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            Toast.makeText(barishal.this, "Product Added", Toast.LENGTH_LONG).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(barishal.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
